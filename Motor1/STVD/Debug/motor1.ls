  ...
  24  0006 01            	dc.b	1
  76                     ; 14 void Motor1MoveCCW(uint8_t val)
  76                     ; 15 {	
  78                     	switch	.text
  79  0000               _Motor1MoveCCW:
  81  0000 88            	push	a
  82  0001 88            	push	a
 ...
 110                     ; 22 	Motor1Stop();
 112  0012 ad1a          	call	_Motor1Stop
 114                     ; 23 }
 117  0014 85            	popw	x
 118  0015 81            	ret
 164                     ; 25 void Motor1MoveCW(uint8_t val)
 164                     ; 26 {	
 165                     	switch	.text
 166  0016               _Motor1MoveCW:
 168  0016 88            	push	a
 169  0017 88            	push	a
 ...
 183  0020               L56:
 184                     ; 31 	Motor1Move();
 186  0020 ad31          	call	_Motor1Move
 ...
 263                     ; 44 }
 266  0052 81            	ret
 295                     ; 46 void Motor1Move(void) {
 296                     	switch	.text
 297  0053               _Motor1Move:
 ...
 733                     	xdef	_Sequence
 734                     	xdef	_Motor1Stop
 735                     	xdef	_Motor1MoveCW
 736                     	xdef	_Motor1MoveCCW
 737                     	xdef	_Motor1Move
 738                     	xref	_millis
